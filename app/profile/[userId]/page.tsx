...
import ProfilePictureLG from "@/components/profile/profile-picture-lg";
import Banner from "@/components/profile/profile-banner";
import { NameAndTag } from "@/components/profile";
...
import { ProfilePictureSM, FollowButton } from "@/components/profile";
                        ...
                        <div className = "flex flex-col w-full h-full">
                            ...
                            <div className = "pt-3 px-4 mb-4">
                                ...
                                <div className = "flex flex-row items-start justify-between">
                                    <div>
                                        <ProfilePictureLG userId={userProfile.id} avatarUrl={userProfile.avatar_url} />
                                    </div>
                                    <div>
                                        <EditProfileDialog />
                                    </div>
                                ...
                                <div className = "flex flex-col">
                                    <Heading>{userProfile.full_name}</Heading>
                                ...
                                {/* Bio */}
                                <Description >
                                    <span className="text-foreground">{userProfile.bio}</span>
                                </Description>
