...
interface PostBoxProps {
  post: any; // Replace `any` with the appropriate type for your post object
  stats: {
    likes: number;
    comments: number;
    reposts: number;
...
const PostBox: React.FC<PostBoxProps> = ({ post, stats, userId }) => {
  return (
    <div className="border-b-[1px] block border-border">
                          ...
                          <div className="ml-[4px] flex flex-row shrink-1">
                            <div className="items-baseline flex flex-row">
                              ...
                              <div className="shrink-0 flex flex-row">
                                ...
                                <time dateTime={post.created_at}>{timeSince(post.created_at)}</time>
                                </span>
                              </div>
                            </div>
                          </div>
